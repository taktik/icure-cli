...
export function forEachDeep(
  objOrArray: unknown | Array<any>,
  action: (obj: any, parent: unknown | Array<any>, idx: number) => void
): void {
...
export function mapDeep<T extends { [index: string]: any } | Array<any>>(
  objOrArray: T,
  map: (obj: any, parent: unknown | Array<any>, idx: number) => any
): T {
  if (isArray(objOrArray)) {
    return objOrArray.map((child, idx) => {
